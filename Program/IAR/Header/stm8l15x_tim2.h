...
void TIM2_TimeBaseInit(TIM2_Prescaler_TypeDef TIM2_Prescaler,//TIM2初始化
                       TIM2_CounterMode_TypeDef TIM2_CounterMode, uint16_t TIM2_Period);

void TIM2_PrescalerConfig(TIM2_Prescaler_TypeDef Prescaler,
                          TIM2_PSCReloadMode_TypeDef TIM2_PSCReloadMode);//设置分频系数
void TIM2_CounterModeConfig(TIM2_CounterMode_TypeDef TIM2_CounterMode);//设置计数模式
void TIM2_SetCounter(uint16_t Counter);//设置计数值
void TIM2_SetAutoreload(uint16_t Autoreload);//设置重载值
uint16_t TIM2_GetCounter(void);
TIM2_Prescaler_TypeDef TIM2_GetPrescaler(void);//得到分频系数
